...
class TestNotifyCommand:
    def test_skips_when_no_channels(self, capsys):
    ...
    def test_errors_when_no_digest(self, tmp_path, capsys):
        from comp_synth.main import main
    ...
    def test_sends_latest_digest(self, tmp_path, capsys):
        from comp_synth.main import main
    ...
    def test_sends_specified_file(self, tmp_path, capsys):
        from comp_synth.main import main
    ...
    def test_errors_when_specified_file_missing(self, tmp_path, capsys):
        from comp_synth.main import main
    ...
    def test_errors_when_file_not_markdown(self, tmp_path, capsys):
        from comp_synth.main import main
